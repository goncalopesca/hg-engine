...
u16 sGoldenrodDepartmentUpper2F[] = {
    ITEM_POTION, ITEM_SUPER_POTION, ITEM_ORAN_BERRY,
    ITEM_ANTIDOTE, ITEM_PARALYZE_HEAL, ITEM_BURN_HEAL, ITEM_ICE_HEAL, 
    ITEM_AWAKENING, 0xFFFF
};

u16 sGoldenrodDepartmentLower2F[] = {
    ITEM_POKE_BALL, ITEM_ESCAPE_ROPE, ITEM_POKE_DOLL, ITEM_MAX_REPEL, 
    ITEM_RARE_CANDY, ITEM_GRASS_MAIL, ITEM_FLAME_MAIL, ITEM_BUBBLE_MAIL, ITEM_SPACE_MAIL, 0xFFFF
};

u16 sGoldenrodDepartment3F[] = {
    ITEM_SMOKE_BALL, ITEM_EVERSTONE, ITEM_GRIP_CLAW, ITEM_FOCUS_BAND, ITEM_IRON_BALL,
    ITEM_LAGGING_TAIL, 0xFFFF
};

u16 sGoldenrodDepartment4F[] = {
    ITEM_FIRE_STONE, ITEM_WATER_STONE, ITEM_THUNDER_STONE, ITEM_LEAF_STONE, ITEM_MOON_STONE,
    ITEM_SUN_STONE, ITEM_SHINY_STONE, ITEM_DUSK_STONE, ITEM_DAWN_STONE, 0xFFFF
};

u16 sGoldenrodDepartment5F[] = {
    ITEM_TM063, ITEM_TM058, ITEM_TM054, ITEM_TM041, ITEM_TM007,
    ITEM_TM005, ITEM_TM067, ITEM_TM056, ITEM_TM048, ITEM_TM037,
    ITEM_TM083, ITEM_TM076, 0xFFFF
};

u16 sGoldenrodHerbs[] = {
    ITEM_GROWTH_MULCH, ITEM_DAMP_MULCH, ITEM_STABLE_MULCH, ITEM_GOOEY_MULCH, 0xFFFF
};

u16 sEcruteakMart[] = {
    ITEM_STICKY_BARB, ITEM_PECHA_BERRY, ITEM_CHERI_BERRY, 0xFFFF
};

u16 sOlivineMart[] = {
    ITEM_RAWST_BERRY, ITEM_PERSIM_BERRY, ITEM_TM012, ITEM_NET_BALL, ITEM_HEART_SCALE, 0xFFFF
};
...
u16 sVermilionAndSafariMart[] = {
    ITEM_TM077, ITEM_TM020, ITEM_TM082, ITEM_TM045, ITEM_TM043, ITEM_TM040, 
    ITEM_TM016, ITEM_TM033, ITEM_TM011, ITEM_TM018, ITEM_TM031, ITEM_TM087, 0xFFFF
};
