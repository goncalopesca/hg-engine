...
const u8 sTrainerGenders[] = {
    ...
    [TRAINERCLASS_BIRD_EXPERT_PARTNER] = TRAINER_MALE,
    [TRAINERCLASS_ROCK_EXPERT_PARTNER] = TRAINER_MALE,
    ...
    //New trainer classes
    [TRAINERCLASS_ROCK_EXPERT] = TRAINER_MALE,
    [TRAINERCLASS_BIRD_EXPERT] = TRAINER_MALE,
    [TRAINERCLASS_LIGHTHOUSE_KEEPER] = TRAINER_MALE,
    [TRAINERCLASS_THE_STRONGEST_MAN] = TRAINER_MALE,
    [TRAINERCLASS_SYNDICATE_BOSS] = TRAINER_MALE,
    [TRAINERCLASS_PKMN_TRAINER_PIKSUDO] = TRAINER_MALE,
    [TRAINERCLASS_TIME_TRAVELER] = TRAINER_MALE,
    [TRAINERCLASS_SYNDICATE_MEMBER_M] = TRAINER_MALE,
    [TRAINERCLASS_SYNDICATE_MEMBER_F] = TRAINER_FEMALE,
    [TRAINERCLASS_MATCH_FANATIC] = TRAINER_MALE,
    [TRAINERCLASS_MAD_SCIENTIST] = TRAINER_MALE,
    [TRAINERCLASS_HOT_SHOT] = TRAINER_MALE,
    [TRAINERCLASS_OREWA_KING] = TRAINER_MALE,
    [TRAINERCLASS_WILD_POKEMON] = TRAINER_MALE,
    [TRAINERCLASS_MAGNATE] = TRAINER_MALE,
};
