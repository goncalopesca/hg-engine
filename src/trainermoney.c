...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_KIMONO_GIRL, .multiplier = 8 },
    ...
    //new trainer classes
    { .class = TRAINERCLASS_ROCK_EXPERT, .multiplier = 20 },
    { .class = TRAINERCLASS_BIRD_EXPERT, .multiplier = 15 },
    { .class = TRAINERCLASS_LIGHTHOUSE_KEEPER, .multiplier = 15 },
    { .class = TRAINERCLASS_THE_STRONGEST_MAN, .multiplier = 15 },
    { .class = TRAINERCLASS_SYNDICATE_BOSS, .multiplier = 15 },
    { .class = TRAINERCLASS_PKMN_TRAINER_PIKSUDO, .multiplier = 50 },
    { .class = TRAINERCLASS_TIME_TRAVELER, .multiplier = 20 },
    { .class = TRAINERCLASS_SYNDICATE_MEMBER_M, .multiplier = 15 },
    { .class = TRAINERCLASS_SYNDICATE_MEMBER_F, .multiplier = 15 },
    { .class = TRAINERCLASS_MATCH_FANATIC, .multiplier = 20 },
    { .class = TRAINERCLASS_MAD_SCIENTIST, .multiplier = 15 },
