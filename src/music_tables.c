...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_BLACK_BELT] = {0xFFFF, SEQ_GS_VS_TRAINER},
    [ANIM_MUSIC_COMBO_RED] = {0x2E, SEQ_GS_VS_CHAMP},
    // (***END OF VANILLA ENTRIES***)
    //new trainer classes
    [ANIM_MUSIC_COMBO_ROCK_EXPERT] = {0xFFFF, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_BIRD_EXPERT] = {0xFFFF, SEQ_GS_BA_BRAIN},
    [ANIM_MUSIC_COMBO_LIGHTHOUSE_KEEPER] = {0xFFFF, SEQ_GS_BA_BRAIN},
    [ANIM_MUSIC_COMBO_THE_STRONGEST_MAN] = {0xFFFF, SEQ_GS_BA_BRAIN},
    [ANIM_MUSIC_COMBO_SYNDICATE_BOSS] = {0xFFFF, SEQ_GS_BA_BRAIN},
    [ANIM_MUSIC_COMBO_PKMN_TRAINER_PIKSUDO] = {0xFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_TIME_TRAVELER] = {0xFFFF, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_MATCH_FANATIC] = {0xFFFF, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_MAD_SCIENTIST] = {0xFFFF, SEQ_GS_BA_BRAIN},
    [ANIM_MUSIC_COMBO_HOT_SHOT] = {0xFFFF, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_OREWA_KING] = {0xFFFF, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_MAGNATE] = {0xFFFF, SEQ_GS_BA_BRAIN},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_BLACK_BELT, ANIM_MUSIC_COMBO_BLACK_BELT*4},
    {TRAINERCLASS_PKMN_TRAINER_RED, ANIM_MUSIC_COMBO_RED*4},
    // (***END OF VANILLA ENTRIES***)
    //New trainer classes
    {TRAINERCLASS_ROCK_EXPERT, ANIM_MUSIC_COMBO_ROCK_EXPERT*4},
    {TRAINERCLASS_BIRD_EXPERT, ANIM_MUSIC_COMBO_BIRD_EXPERT*4},
    {TRAINERCLASS_LIGHTHOUSE_KEEPER, ANIM_MUSIC_COMBO_LIGHTHOUSE_KEEPER*4},
    {TRAINERCLASS_THE_STRONGEST_MAN, ANIM_MUSIC_COMBO_THE_STRONGEST_MAN*4},
    {TRAINERCLASS_SYNDICATE_BOSS, ANIM_MUSIC_COMBO_SYNDICATE_BOSS*4},
    {TRAINERCLASS_PKMN_TRAINER_PIKSUDO, ANIM_MUSIC_COMBO_PKMN_TRAINER_PIKSUDO*4},
    {TRAINERCLASS_TIME_TRAVELER, ANIM_MUSIC_COMBO_TIME_TRAVELER*4},
    {TRAINERCLASS_MATCH_FANATIC, ANIM_MUSIC_COMBO_MATCH_FANATIC*4},
    {TRAINERCLASS_MAD_SCIENTIST, ANIM_MUSIC_COMBO_MAD_SCIENTIST*4},
    {TRAINERCLASS_HOT_SHOT, ANIM_MUSIC_COMBO_HOT_SHOT*4},
    {TRAINERCLASS_OREWA_KING, ANIM_MUSIC_COMBO_OREWA_KING*4},
    {TRAINERCLASS_WILD_POKEMON, ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS*4},
    {TRAINERCLASS_MAGNATE, ANIM_MUSIC_COMBO_MAGNATE*4},
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_SYNDICATE_MEMBER_M, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_SYNDICATE_MEMBER_F, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
};
